...
export const EndModal = ({title, isGameMode, onClose, subTitle, coins, btnText}) => {
    const ratio = useSizeRatio();

    return (
        <GameModal isBoldTitle onClose={onClose} btnText={btnText ?? (isGameMode ? 'Играть ещё' : 'Забрать')} title={title} secondBtnText={isGameMode ? "Вернуться на главный экран" : undefined}>
