...
/* ---------- Styled Components (только статичные стили) ---------- */
...
const ShuffleNotice = styled.div`
  position: fixed;
  top: 50%;
  left: 50%;
...
const Match3Game = () => {
  ...
  return (
    <Container>
          ...
          row.map((cell, c) => {
            ...
            return (
              <Cell
                key={`${r}-${c}`}
                style={{
                  backgroundColor: cell !== null && cell !== undefined ? COLORS[cell] : 'transparent',
                  opacity: cell !== null && cell !== undefined ? 1 : 0,
      ...
      <ShuffleNotice style={{ opacity: showShuffle ? 1 : 0 }}>
