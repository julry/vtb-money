...
export const LockIcon = memo(function LockIcon({
    ...
    return (
        ...
        >
            ...
            <rect x="2.29297" y="27.2927" width="50" height="40" rx="6.87806" stroke="white" strokeWidth="4.58537"/>
            <path d="M14.793 16.0427C14.793 8.44881 20.9491 2.29272 28.543 2.29272V2.29272C36.1369 2.29272 42.293 8.44881 42.293 16.0427V27.2927H14.793V16.0427Z" stroke="white" strokeWidth="4.58537"/>
            </g>
            </svg>
        </Wrapper>
    );
